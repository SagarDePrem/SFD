...
global aunit xmu rkcoef tfactor acc_srp nsegments
...
transfer_time = tfactor * f(1);

transfer_angle = rtd * x6(end);

fprintf ('\n total transfer angle  %12.8f degrees \n\n', transfer_angle);

if (iplanet == 2)
    
    % Earth-to-Mars; determine departure and arrival calendar dates
